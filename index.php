...
<div class="container" style="max-width: 1200px;">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<ul style="list-style-type:disc">
						<li>
							<p>The “Zubairy Classrooms” Website (web based application) is useful for the
	...
	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header">Zubairy CLASSROOMS</h2>
		</div>
		<div class="col-md-6">
			<p>The Zubairy CLASSROOMS by <strong>Elhamuddin Mayar</strong> includes:</p>
			<ul>
